package com.dzakyhdr.holandshipper.common;
...
import com.dzakyhdr.holandshipper.R;
import com.dzakyhdr.holandshipper.model.ShipperUserModel;
import com.dzakyhdr.holandshipper.model.TokenModel;
...
public class Common {
    ...
    public static ShipperUserModel currentShiperUser;
    ...
    public static void updateToken(Context context, String newToken, boolean isServer, boolean isShipper) {
        FirebaseDatabase.getInstance()
                ...
                .child(Common.currentShiperUser.getUid())
                .setValue(new TokenModel(Common.currentShiperUser.getPhone(),newToken,isServer,isShipper))
